...
<section class="">
<?php
$data["posts"]=LicenciaData::getAll();
...
?>
 ...
 <div class="card">
                ...
                <div class="row">
                    <div class="col-lg-12">
                   <!-- <a href="./?view=licencias&opt=new" class="btn btn-secondary">Nueva Licencia</a>
                    <a href="./licenciasreport.php" class="btn btn-success" target="_blank">Descargar</a>
                -->
                    <!-- <a href="./licenciasreport.php" class="btn btn-success" target="_blank">Descargar</a> -->
<form class="row g-3" id="filter_form">
  <div class="col-auto">
        <a href="./?view=licencias&opt=new" class="btn btn-secondary">Nuevo Licencia</a>
  </div>
  <div class="col-auto">
  ...
  <div class="col-auto">
<a href="./licenciasreport.php" id="link_report" class="btn btn-success" target="_blank">Descargar</a>
  </div>
</form>
<script type="text/javascript">
    $("#date_start").change(function(){
        ...
        if(val1!="" && val2!=""){
        link = $("#link_report").attr("href","./licenciasreport.php?start="+val1+"&end="+val2);       
        //alert(val1);
        $.get("./?action=gettablelicencias",$("#filter_form").serialize(), function(data){
...
//                alert(data);
  Swal.fire({ title: data, text: data, icon: "success" });
                ...
                $("#ciuda_address_ref").val("");
                        ...
                        <form role="form" method="post" action="./?action=licencias&opt=add" enctype="multipart/form-data">
                            <!--
                            <div class="form-group">
      ...
      <select name="client_id" id="client_list" required class="form-control" required>
        ...
        <?php endforeach; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="vigencia"  class="form-control" placeholder="Año Vigencia">
                            </div>
...
<?php
$user = LicenciaData::getById($_GET["id"]);
...
?>
 ...
 <div class="card">
                  ...
                  <div class="card-body">
                        <form role="form" method="post" action="./?action=licencias&opt=update" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Folio</label>
                            ...
                            <div class="form-group">
                                <label>Negocio</label>
                                <input type="text" value="<?php echo $user->negocio;?>" name="negocio"  class="form-control" placeholder="Negocio">
                            </div>
                            <div class="form-group">
                                <label>Año Vigencia</label>
                                <input type="text" value="<?php echo $user->vigencia;?>" name="vigencia" required  class="form-control" placeholder="Año Vigencia">
                            </div>
                            <input type="hidden" name="amount" value="0">
                            <!--
                            <div class="form-group">
