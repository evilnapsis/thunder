...
?>
 ...
 <div class="card">
                ...
                <div class="row">
                    <div class="col-lg-12">
                    <a href="./?view=instalations&opt=new" class="btn btn-secondary">Nueva Instalacion</a>
   <!--                 <a href="./instalationsreport.php" class="btn btn-success" target="_blank">Descargar</a>
-->
                    <br><br>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <form role="form" method="post" action="./?action=instalations&opt=add" enctype="multipart/form-data">
                            <!--
...
?>
 ...
 <div class="card">
                  ...
                  <div class="card-body">
                        <form role="form" method="post" action="./?action=instalations&opt=update" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Codigo</label>
