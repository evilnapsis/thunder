...
<section class="">
<?php
$data["posts"]=AudienciaData::getAll();
?>
...
<form class="row g-3" id="filter_form">
  <div class="col-auto">
        <a href="./?view=audiencias&opt=new" class="btn btn-secondary">Nuevo Audiencia</a>
  </div>
  <div class="col-auto">
  ...
  <div class="col-auto">
<a href="./audienciasreport.php" id="link_report" class="btn btn-success" target="_blank">Descargar</a>
  </div>
</form>
<script type="text/javascript">
    $("#date_start").change(function(){
        ...
        if(val1!="" && val2!=""){
        link = $("#link_report").attr("href","./audienciasreport.php?start="+val1+"&end="+val2);       
        //alert(val1);
        $.get("./?action=gettableaudiencias",$("#filter_form").serialize(), function(data){
    ...
    $("#date_end").change(function(){
        ...
        url: './vendors/datatables/esmx.json',
                    ...
                    <!-- <a href="./audienciasreport.php" class="btn btn-success" target="_blank">Descargar</a> -->
                    <br>
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "./?action=audiencias&opt=del&id=<?=$post->id;?>";
    ...
    .end();
              ...
              // alert(result)
                ...
                alert("No hay resultados");
                        ...
                        <form role="form" method="post" action="./?action=audiencias&opt=add" enctype="multipart/form-data">
                            <!--
                            <div class="form-group">
      ...
      <select name="client_id" id="client_list" required class="form-control" required>
        <option value="">-- SELECCIONE --</option>
                            ...
                            <div class="form-group">
                                <label>Tipo de Apoyo que solicita*</label>
      <select name="tipo_apoyo_id" required class="form-control" required>
        <option value="">-- SELECCIONE --</option>
<?php foreach(TipoApoyoData::getAll() as $tt):
...
$audiencias = AudienciaData::getAll();
    ?>
...
<section class="container">
 ...
 <div class="card">
                  <div class="card-header">
                    <strong>Calendario de Audiencias</strong>
                  </div>
                  <div class="card-body">
                            <a href="./?view=audiencias&opt=new" class="btn btn-secondary">Nuevo Audiencia</a>
<br><br>
    ...
    <script>
      ...
      headerToolbar: {
        ...
        right: 'dayGridMonth,timeGridWeek,timeGridDay'
           ...
           events:
            [
                <?php foreach($audiencias as $audi):
$cli = ClientData::getById($audi->client_id);
if($cli):
$tipo = TipoApoyoData::getById($audi->tipo_apoyo_id);
                    ?>
              {
                id: 1,
                title: '<?php echo $cli->name." ".$cli->name2." ".$cli->lastname." ".$cli->lastname2; ?> - <?php echo $tipo->name; ?>',
                start: '<?php echo $audi->date_at; ?>T10:00:00',
...
<section class="container">
<?php
$user = AudienciaData::getById($_GET["id"]);
...
?>
 ...
 <div class="card">
                  ...
                  <div class="card-body">
                        <form role="form" method="post" action="./?action=audiencias&opt=update" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Folio</label>
