...
$data["posts"]=CorteTesoreriaData::getAll();
}else{
$data["posts"]=CorteTesoreriaData::getAllBy("user_id",Core::$user->id);
...
?>
 ...
 <div class="card">
                  <div class="card-header">
                    <strong>Cortes de Caja (Tesoreria)</strong>
                  </div>
                  <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                    <a href="./?view=cortestesoreria&opt=new" class="btn btn-secondary">Nuevo Corte de Caja</a>
...
$cobros=CobroTesoreriaListData::getAllBy("corte_id",$post->id);
$cobros2=CobroSeguridadListData::getAllBy("corte_teso_id",$post->id);
foreach($cobros2 as $cob){ $cobros[] = $cob;}
$totaltotal=0; 
foreach($cobros as $cobro){
    if($cobro->corte_id){
                        $cobros = CobroTesoreriaData::getAllBy("cobro_tesoreria_list_id",$cobro->id);
                    }else if($cobro->corte_teso_id){
...
if($post->amount_end!=null){
    ...
    $diferencia = $entregado - $recibido;
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="./?view=cortestesoreria&opt=open&id=<?php echo $post->id; ?>">#<?php echo $post->id; ?></a>
                                                </td>
                                                ...
                                                <a href="./?view=cortestesoreria&opt=edit&id=<?=$post->id;?>" class="btn btn-sm btn-warning"><i class="bi-pencil"></i></a>
                                            <a href="./cobrostesoreriacorte.php?id=<?php echo $post->id; ?>" id="link_report" class="btn btn-success btn-sm" target="_blank">Descargar</a>
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "./?action=cortestesoreria&opt=del&id=<?=$post->id;?>";
...
<!-- Inicio de card -->
 <div class="card">
                  <div class="card-header">
                    <strong>Mi Corte de Caja [Tesoreria]</strong>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-12">
<?php if($last!=null):?>
    <p class="alert alert-info">La caja esta abierta, puedes realizar tus ventas, al terminar ingresa tu monto final.</p>
                        <form role="form" method="post" action="./?action=cortestesoreria&opt=finish" enctype="multipart/form-data">
...
<?php
$data["posts"]=CobroTesoreriaListData::getAllBy("corte_id",$last->id);
?>
<div class="box box-primary">
                            <div class="box-body">
                                <div id="filter_table">
...
<h3>COBROS DE MULTAS EN ESTE CORTE</h3>

<?php
$data["posts"]=CobroSeguridadListData::getAllBy("corte_teso_id",$last->id);
...
<?php else:?>
    <p class="alert alert-warning">La caja esta cerrada, para iniciar ingresa tu monto de caja inicial.</p>
                        <form role="form" method="post" action="./?action=cortestesoreria&opt=add" enctype="multipart/form-data">
                            <!--
                            <div class="form-group">
                                <label>Imagen (480x480)</label>
                                <input type="file" name="image">
...
<?php
$user = CorteTesoreriaData::getById($_GET["id"]);
?>
 ...
 <div class="card">
                  ...
                  <div class="card-body">
                        <form role="form" method="post" action="./?action=cortestesoreria&opt=update" enctype="multipart/form-data">
...
?>
 ...
 <div class="card">
                  ...
                  <div class="card-body">
                    <a href="./cobrostesoreriacorte.php?id=<?php echo $user->id; ?>" id="link_report" class="btn btn-success" target="_blank">Descargar</a><br><br>
                        <div role="form" method="post" action="./?action=cortestesoreria&opt=update" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Monto Inicial</label>
                                <input type="text" name="amount_start"  value="<?=$user->amount_start;?>" class="form-control" placeholder="Monto Inicial">
                            </div>                            <div class="form-group">
...
<h3>COBROS EN ESTE CORTE</h3>
<?php
$data["posts"]=CobroTesoreriaListData::getAllBy("corte_id",$user->id);
?>
<div class="box box-primary">
                            <div class="box-body">
                                <div id="filter_table">
...
<?php
$data["posts"]=CobroSeguridadListData::getAllBy("corte_teso_id",$user->id);
