<?php
class LicenciaData {
	public static $tablename = "licencia";
	public $id;
	public $name;
	public $code;
	public $motivo;
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (code, date_at, client_id, negocio, amount, vigencia, created_at) ";
		 $sql .= "value (\"$this->code\",\"$this->date_at\",\"$this->client_id\",\"$this->negocio\",\"$this->amount\",\"$this->vigencia\",NOW())";
	...
	public function update(){
		$sql = "update ".self::$tablename." set negocio=\"$this->negocio\",amount=\"$this->amount\",vigencia=\"$this->vigencia\",status=\"$this->status\" where id=$this->id";
		Executor::doit($sql);
	}
	...
	public static function getById($id){
		...
		return Model::one($query[0],new LicenciaData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new LicenciaData());
	}
