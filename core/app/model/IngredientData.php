<?php
class IngredientData extends Extra {
	public static $tablename = "ingredient";

	public $id, $code, $name, $price_in, $price_out, $unit, $is_active, $user_id, $created_at;
	...
	public function update(){
		$sql = "update ".self::$tablename." set name=\"$this->name\",price_in=\"$this->price_in\",price_out=\"$this->price_out\",unit=\"$this->unit\",code=\"$this->code\" where id=$this->id";
		Executor::doit($sql);
	}
