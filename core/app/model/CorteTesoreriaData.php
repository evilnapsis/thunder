<?php
class CorteTesoreriaData {
	public static $tablename = "corte_tesoreria";
	public $id;
	public $amount_start;
	public $amount_end;
	public $start_at;
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CorteTesoreriaData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CorteTesoreriaData());
	}
