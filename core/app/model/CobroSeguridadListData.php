<?php
class CobroSeguridadListData {
	public static $tablename = "cobro_seguridad_list";
	public $id;
	public $name;
	public $code;
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (code, cat_seguridad_id, client_id, forma_pago_id, corte_id, corte_teso_id, created_at) ";
		 $sql .= "value (\"$this->code\",$this->cat_seguridad_id, \"$this->client_id\",\"$this->forma_pago_id\",$this->corte_id, $this->corte_teso_id, NOW())";
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CobroSeguridadListData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CobroSeguridadListData());
	}
	...
	public static function getAllByCatCli($k,$v){
		 $sql = "select * from ".self::$tablename." where cat_seguridad_id=$k and client_id=\"$v\"";
		$query = Executor::doit($sql);
		return Model::many($query[0],new CobroSeguridadListData());
	}
