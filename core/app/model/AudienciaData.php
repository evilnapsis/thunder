<?php
class AudienciaData {
	public static $tablename = "audiencia";
	public $id;
	public $name;
	public $code;
	public $motivo;
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (code, date_at,time_at, tipo_apoyo_id, client_id, motivo, resolucion, amount, created_at) ";
		 $sql .= "value (\"$this->code\",\"$this->date_at\",\"$this->time_at\",$this->tipo_apoyo_id, \"$this->client_id\",\"$this->motivo\",\"$this->resolucion\",\"$this->amount\",NOW())";
	...
	public static function getById($id){
		...
		return Model::one($query[0],new AudienciaData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new AudienciaData());
	}
	...
	public static function getAllByCatCli($k,$v){
		 $sql = "select * from ".self::$tablename." where tipo_apoyo_id=$k and client_id=\"$v\"";
		$query = Executor::doit($sql);
		return Model::many($query[0],new AudienciaData());
	}
