...
<div class="row">
    ...
    <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" value="<?php echo date("Y-m-d"); ?>" <?php if(Core::$user->kind==11):?>readonly<?php endif;?> name="date_at" class="form-control" placeholder="Fecha">
                            </div>
    </div>
...
<div class="col-md-8">
    <div class="form-group">
      ...
      <select name="servicio_seguridad_id" id="servicio_seguridad_id"  required class="form-control" required>
        <option value="">-- SELECCIONE --</option>
        <?php foreach(ServicioSeguridadData::getAllBy("cat_seguridad_id", $_GET['cat_seguridad_id']) as $k):?>
...
<script type="text/javascript">
    $("#servicio_seguridad_id").change(function(){
        $.get("./?action=getservicioseguridad","id="+$("#servicio_seguridad_id").val(),function(data){
            $("#amount").val(data);
            $("#total").val(data);
        });
    });
...
<script type="text/javascript">
    $("#cobro_form").submit(function(e){
        e.preventDefault();
        $.post("./?action=addtocobrosseguridad",$("#cobro_form").serialize(), function(data){
