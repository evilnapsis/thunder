...
if($start!="" && $end!=""){
    $data["posts"]=CobroTesoreriaListData::getAllByRangeCat($start, $end, $cat);
}else{
    $data["posts"]=CobroTesoreriaListData::getAllBy("cat_tesoreria_id", $cat);    
}

}else{

if($start!="" && $end!=""){
$data["posts"]=CobroTesoreriaListData::getAllByRange($start, $end);
}
else{
...
<table class="table datatable table-bordered table-hover table-striped">
                                        ...
                                        <?php $totaltotal=0; foreach($data["posts"] as $post):
                                            ...
                                            <tr>
                                                ...
                                                <a href="./?action=cobrostesoreria&opt=del&id=<?=$post->id;?>" class="btn btn-sm btn-danger"><i class="bi-trash"></i></a>
                                                </td>
                                            </tr>
